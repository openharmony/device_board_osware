...
public:
    ...
    RetCode ReqBuffers(const std::string& cameraID, unsigned int buffCont, enum v4l2_memory memoryType);
    ...
    static std::map<std::string, std::string> CreateDevMap(void)
    {
    ...
    static std::map<std::string, int> CreateFdMap(void)
    {
